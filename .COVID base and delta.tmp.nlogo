...
globals
  [ %infected            ;; what % of the population is infectious
    ...
    carrying-capacity    ;; the number of people that can be in the world at one time
    immunity-duration ]  ;; how many weeks immunity lasts

;; The reset is divided into four procedures
to reset
  clear-all
  reset-constants
  reset-people
...
;; We create a variable number of people of which 10 are infectious,
...
to get-older ;; turtle procedure
  ...
  set age age + 1
  if age > lifespan [ die ]
  if immune? [ set remaining-immunity remaining-immunity - 5 ]
...
to startup
  reset-constants ;; so that carrying-capacity can be used as upper bound of number-people slider
end
